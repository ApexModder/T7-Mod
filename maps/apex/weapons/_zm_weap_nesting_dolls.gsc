...
include_weapon_for_level()
{
	...
	maps\apex\_zm_weapons::register_zombie_weapon_callback("zombie_nesting_dolls", ::player_give_nesting_dolls);
...
{
	return maps\apex\_zm_weapons::is_weapon_included("zombie_nesting_dolls");
}
...
// lightining chain netsing dolls
