...
include_weapon_for_level()
{
	...
	maps\apex\_zm_weapons::register_zombie_weapon_callback("zombie_black_hole_bomb", ::player_give_black_hole_bomb);
...
{
	return maps\apex\_zm_weapons::is_weapon_included("zombie_black_hole_bomb");
}
